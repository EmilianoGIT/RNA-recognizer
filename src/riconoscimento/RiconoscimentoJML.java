...
public class RiconoscimentoJML {
	...
	/*@
	  @ normal_behaviour
	  @ requires this.testInput(in) == true; 
	  @ exceptional_behavior
	  @ signals(InputSequenceException e )testInput(in) == false;
	*/
	public RiconoscimentoJML(String in) throws InputSequenceException {
	...
	public RiconoscimentoJML() {
		
	}
	/*@
	  @ normal_behaviour
	  @ requires s.length() != 0 && s.matches("[aucg]*");
	*/
